...
extension Defaults.Keys {
  ...
  static let popupPosition = Key<PopupPosition>("popupPosition", default: .topCenter)
  ...
  static let windowSize = Key<NSSize>("windowSize", default: NSSize(width: 1400, height: 280))
  ...
  static let viewMode = Key<ViewMode>("viewMode", default: .list)
}
